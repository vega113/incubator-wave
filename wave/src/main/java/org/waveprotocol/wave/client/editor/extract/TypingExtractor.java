...
//            }
  ...
  public void somethingHappened(Point<Node> previousSelectionStart)
      throws HtmlMissing, HtmlInserted {
    Preconditions.checkNotNull(previousSelectionStart, "previousSelectionStart")
    ...
    if (t == null) {
      ...
      if (node != null) {
        ...
        Preconditions.checkNotNull(previousSelectionStart.asTextPoint(), "previousSelectionStart.asTextPoint()")
        ...
        Preconditions.checkState(!previousSelectionStart.isInTextNode(), "!previousSelectionStart.isInTextNode()")
