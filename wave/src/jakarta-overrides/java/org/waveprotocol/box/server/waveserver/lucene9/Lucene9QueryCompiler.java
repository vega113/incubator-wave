...
public class Lucene9QueryCompiler {
  ...
  public Query compile(Lucene9QueryModel model, ParticipantId user) throws InvalidQueryException {
    ...
    // tasks: filters are evaluated by the legacy provider against live wave data so reserved
    // semantics like tasks:all and annotation-based task matching stay authoritative.
